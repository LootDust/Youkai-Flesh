...
public class CookedFleshSliceItem extends FleshFoodItem {
    ...
    public @NotNull ItemStack finishUsingItem(@NotNull ItemStack stack, @NotNull Level level, @NotNull LivingEntity consumer) {
        ...
        if (consumer instanceof Player player) {
            consume(player, 1.0, YFConfig.COOKED_FLESH_SLICE_YOUKAIFYING_TIME_MULTIPLIER.get(), YFConfig.COOKED_FLESH_SLICE_YOUKAIFIED_TIME_MULTIPLIER.get());
        }
        return remains;
    }
}
