...
public class FleshSliceItem extends FleshFoodItem {
    public FleshSliceItem() {
        super();
    }
    ...
    public @NotNull ItemStack finishUsingItem(@NotNull ItemStack stack, @NotNull Level level, @NotNull LivingEntity consumer) {
        ...
        if (consumer instanceof Player player) {
            consume(player, 1.0, YFConfig.FLESH_SLICE_YOUKAIFYING_TIME_MULTIPLIER.get(), YFConfig.FLESH_SLICE_YOUKAIFIED_TIME_MULTIPLIER.get());
        }
        return remains;
    }
}
